...
namespace DSPAlgorithms.Algorithms
{
    public class TimeDelay : Algorithm
    {
        ...
        public override void Run()
        {
            ...
            OutputTimeDelay = directCorrelation.OutputNonNormalizedCorrelation.IndexOf(directCorrelation.OutputNonNormalizedCorrelation.Max()) * InputSamplingPeriod;
